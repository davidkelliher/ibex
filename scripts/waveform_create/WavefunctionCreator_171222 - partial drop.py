...
# Amplifier 1 gain
A1_gain = 46.71 #46.64 # #46.78

# Amplifier 2 gain
A4_gain = 50.85

# Amplifier 3 gain
A3_gain = 48.8888 #50.11
...
Rods = Waveforms('CROD', seg_len, rod_offset, accumulation_voltage, voltage_array, ramp_time * freq, amp_connect, AWG_gain, max_bits)
FC_endcap = Waveforms('FC', seg_len, endcap_offset, accumulation_voltage, voltage_array, ramp_time* freq, amp_connect, AWG_gain, max_bits, endcap_offset_drop=offset_drop)
