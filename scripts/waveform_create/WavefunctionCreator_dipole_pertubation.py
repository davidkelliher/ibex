...
from functions_dipole_pertubation import *
...
rods_powered = 4
# THIS IS NOW ADAPTED TO A DIPOLE PERTURBATION
# set up so that rods 13 are still powered by one amplifier but now rods 2 and 4 are powered seperately
# pertubation? [freq, amp, rf periods, with or without alternate measurements, with or without wait]
# NOTE THAT AMPLITUDE HERE IS HALF OF TOTAL PERTURBATION
...
pertubation = [0.15*1e6, 0.0, 500, 0, 0]
...
amp_connect = {'CROD13':A1_gain, 'CROD2': A2_gain, 'CROD4':A3_gain}
awg_connect = {'CROD13':'C1', 'CROD2': 'C2', 'CROD4':'C3'}
